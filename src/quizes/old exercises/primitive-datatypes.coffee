...
numbers =
  [ "42", "3.14", "1.617", "140000000", "0.00000000000000000091093822", "13", "100500", ".155", "Infinity", "-Infinity", "10e23", "0101010001", "9.1093822e−31", "NaN", "0xCCFF", "1.4738223E-32" ]

strings =
  [ "Hello, World!", "Lambda Calculus", "JavaScript", "Structure and Interpretation of Computer Programs", "jQuery", "Computer Science", "99 problems", "Nick Cave & The Bad Seeds: The Mercy Seat", "var", "true === 2 + 2", "", "Infinity", "__", "Kanye West: \\\"New Slaves\\\"", "The\\nLittle\\nJavaScripter", "false", "true", "undefined", "null" ]

booleans = [ "true", "false" ]

nullUndefined = [ "null", "undefined" ]

question = "What's the type of this literal?"


$Strings = ->
  randomString = rnd strings
